...
data class InferPluginSettings(
    ...
    var mavenUserArguments: MutableList<String> = mutableListOf("-DskipTests"),
    var gradleUserArguments: MutableList<String> = mutableListOf("-x", "test"),
    var isAutoscrollToSourceEnabled: Boolean = true,
    var isOnSaveAnalyzeEnabled: Boolean = true,
    var isDifferentDirsForModulesEnabled: Boolean = false,
